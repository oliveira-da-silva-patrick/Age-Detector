...
names_path = os.path.join('yolo', 'age_detector.names')
...
def results(filename): 
    ...
    (class_ids, labels, boxes, confidences) = yolo_forward(net, LABELS, image, confidence_level=0.1)
...
if __name__ == "__main__":
    ...
    website_url = 'age-detector.azurewebsites.net'
